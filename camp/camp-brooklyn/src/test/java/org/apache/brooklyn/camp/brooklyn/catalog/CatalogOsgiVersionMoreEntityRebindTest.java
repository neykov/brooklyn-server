...
//        
//        // install dependency
//        installBundle(BROOKLYN_TEST_OSGI_ENTITIES_URL);
//
//        // now the v2 bundle
//        Bundle b = installBundle(BROOKLYN_TEST_MORE_ENTITIES_V2_URL);
//
//        String yaml = Joiner.on("\n").join("name: simple-app-yaml",
//                "services:",
...
//        Assert.assertEquals(b.getState(), Bundle.UNINSTALLED);
//
...
//
//        // now the v2 bundle
//        Bundle b2a = installBundle(BROOKLYN_TEST_MORE_ENTITIES_V2_URL);
//
...
//        installBundle(BROOKLYN_TEST_OSGI_ENTITIES_URL);
//        installBundle(BROOKLYN_TEST_MORE_ENTITIES_V2_URL);
//        
...
//    }
    ...
    protected RegisteredType installWrappedMoreEntity() throws Exception {
        addCatalogItems(
            ...
            "  version: 1.0",
            "  items:",
            "  - id: " + BROOKLYN_TEST_MORE_ENTITIES_MORE_ENTITY,
            "    brooklyn.libraries:",
